...
#firing_sound = simplegui.load_sound("http://commondatastorage.googleapis.com/codeskulptor-assets/sounddogs/thrust.mp3")
...
def draw(canvas):
    ...
    #draw firing line
    orientation = angle_to_vector(firing_angle)
    upper_endpoint = [FIRING_POSITION[0] + FIRING_LINE_LENGTH * orientation[0], 
                      FIRING_POSITION[1] - FIRING_LINE_LENGTH * orientation[1]]
